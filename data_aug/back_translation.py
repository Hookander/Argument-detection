...
cleaned_domains = [domains[i] for i in range(len(sentences)) if labels[i] != 0]
cleaned_labels = [labels[i] for i in range(len(sentences)) if labels[i] != 0]
...
arg_aug_trad_csv.to_csv('./docs/csv/arg_aug_trad.csv')